...
# that already has an instance profile. No instance profile creation needed.
...
module "ec2_instances" {
  ...
  defaults = {
    ...
    iam_instance_profile = "existing-instance-profile-name"  # Use existing instance profile
  ...
  items = {
    web-server-1 = {
      ...
      # You can override the instance profile per instance if needed
      # iam_instance_profile = "different-instance-profile-name"
    ...
    database-server = {
      ...
      # Use a different instance profile for database server
      iam_instance_profile = "database-instance-profile-name"
