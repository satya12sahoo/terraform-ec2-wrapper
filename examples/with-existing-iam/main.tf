# =============================================================================
# Example: Using terraform-ec2-wrapper with existing IAM roles
# =============================================================================
# This example demonstrates how to:
# 1. Create instance profiles for existing IAM roles using the wrapper module
# 2. Use those instance profiles with EC2 instances
# 3. Handle scenarios where you have existing IAM roles without instance profiles

# =============================================================================
# Use terraform-ec2-wrapper with instance profiles
# =============================================================================
